...
exports.UpdatCategory = exports.DeleteCategory = exports.CreateCategory = exports.GetCategory = void 0;
...
var CreateCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_1.Category.create(__assign({}, req.boby))];
            case 1:
                category = _a.sent();
                if (!category) {
...
var DeleteCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_1.Category.findByIdAndRemove(req.params.id)];
            case 1:
                category = _a.sent();
                res.send(category);
                res.status(200).json({
...
var UpdatCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_1.Category.findByIdAndUpdate(req.params.id, __assign({}, req.body), { new: true })];
            case 1:
                category = _a.sent();
                res.send(category);
                return [3 /*break*/, 3];
...
exports.UpdatCategory = UpdatCategory;
